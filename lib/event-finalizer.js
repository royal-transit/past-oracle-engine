...
// FULL REPLACEMENT — BALANCED PAST EVENT FINALIZER V4
...
function classifyEvent(domain, event) {
  ...
  // Likely history in DOB-reduced mode should stay alive
  if (evidenceType === "LIKELY_HISTORY") {
    if (score >= 30) return "EXECUTED";
    if (score >= 14) return "PARTIAL";
    return "NOT_EXECUTED";
  }
